...
![](../.vuepress/public/assets/2020-12-07-14-07-38.png)

（图片来源：[Echart 地图 3D 路径](https://echarts.apache.org/examples/zh/editor.html?c=lines3d-flights-gl&gl=1)）

<!-- TODO 上图的藏南地区不对，需要更换地图，可以用 arcgis 接入的天地图，进行各个省点的连线，比如百度地图，以天地图为例 -->
